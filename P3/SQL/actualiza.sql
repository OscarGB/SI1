...
ALTER TABLE 
  public.clientes OWNER TO alumnodb;
--
...
ALTER TABLE 
  public.actores OWNER TO alumnodb;
CREATE TABLE public.alertas (
  productoid integer PRIMARY KEY NOT NULL, 
  stock integer NOT NULL
);
ALTER TABLE 
  public.alertas OWNER TO alumnodb;
--
...
ALTER TABLE 
  public.directores OWNER TO alumnodb;
--
...
ALTER TABLE 
  public.paises OWNER TO alumnodb;
--
...
ALTER TABLE 
  public.generos OWNER TO alumnodb;
--
...
ALTER TABLE 
  public.lenguas OWNER TO alumnodb;
--
...
ALTER TABLE 
  public.peliculas OWNER TO alumnodb;
--
...
ALTER TABLE 
  public.pedidos OWNER TO alumnodb;
--
...
ALTER TABLE 
  public.productos OWNER TO alumnodb;
--
...
ALTER TABLE 
  public.detallespedidos OWNER TO alumnodb;
...
INSERT INTO public.pedidos (
  pedidoid, fecha, clienteid, precioneto, 
  impuestos, preciototal, estado
) 
SELECT 
  orderid, 
  orderdate, 
...
INSERT INTO public.productos (
  productoid, peliculaid, precio, descripcion, 
  stock, ventas
) 
SELECT 
  products.prod_id, 
...
FROM 
  products 
  LEFT OUTER JOIN inventory ON products.prod_id = inventory.prod_id;
INSERT INTO public.detallespedidos (
  pedidoid, productoid, preciototal, 
  cantidad
) 
SELECT 
  orderid, 
...
FROM 
  orderdetail;
INSERT INTO public.actorpeliculas (
  actorid, peliculaid, personaje, esvoz
) 
SELECT 
  actorid, 
  movieid, 
...
FROM 
  lenguas 
  INNER JOIN imdb_movielanguages ON lenguas.lengua = imdb_movielanguages.language;
...
FROM 
  generos 
  INNER JOIN imdb_moviegenres ON generos.genero = imdb_moviegenres.genre;
...
FROM 
  paises 
  INNER JOIN imdb_moviecountries ON paises.pais = imdb_moviecountries.country;
